...
<head>
<title>蓝色斜纹导航博客模板 - 站长素材</title>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<link href="style.css" rel="stylesheet" type="text/css" />

<script type="text/javascript" src="js/index/cufon-yui.js"></script>
<script type="text/javascript" src="js/index/arial.js"></script>
<script type="text/javascript" src="js/index/cuf_run.js"></script>
<!-- CuFon ends -->
</head>
<body>
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1><a href="index.jsp">Link<span> Interface</span></a><small>Simple web template</small></h1>
      </div>
      <div class="clr"></div>
      <div class="menu_nav">
        <ul>
       ...
       <div class="search">
        <form id="form" name="form" method="post" action="">
          ...
          <input name="b" type="image" src="images/index/search.gif" class="button" />
    ...
    <div class="content_resize">
      <div class="mainbar">
        ...
        <div class="article">
          ...
          <div class="comment">
            <a href="#"><img src="images/index/userpic.gif" width="40" height="40" alt="user" class="userpic" /></a>
        ...
        <div class="article">
          ...
          <ol><li>
            ...
            <input type="image" name="imageField" id="imageField" src="images/index/submit.gif" class="send" />
            <div class="clr"></div>
          </li></ol>
          </form>
        </div>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          <h2>Wise Words</h2>
          <div class="clr"></div>
          <p>   <img src="images/index/test_1.gif" alt="image" width="18" height="17" /> <em>We can let circumstances rule us, or we can take charge and rule our lives from within </em>.<img src="images/index/test_2.gif" alt="image" width="18" height="17" /></p>
  ...
  <div class="fbg">
    <div class="fbg_resize">
      <div class="col c1">
        ...
        <a href="#"><img src="images/index/gallery_1.jpg" width="58" height="58" alt="pix" /></a> <a href="#"><img src="images/index/gallery_2.jpg" width="58" height="58" alt="pix" /></a> <a href="#"><img src="images/index/gallery_3.jpg" width="58" height="58" alt="pix" /></a> <a href="#"><img src="images/index/gallery_4.jpg" width="58" height="58" alt="pix" /></a> <a href="#"><img src="images/index/gallery_5.jpg" width="58" height="58" alt="pix" /></a> <a href="#"><img src="images/index/gallery_6.jpg" width="58" height="58" alt="pix" /></a> </div>
      <div class="col c2">
